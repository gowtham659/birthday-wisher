...
$('document').ready(function(){
		...
		$(window).resize(function(){
			 vw = $(window).width()/2;
			$('#b1,#b2,#b3,#b4,#b5,#b6,#b7,#b8,#b9,#b10,#b20,#b30').stop();
			...
			$('#b120').animate({top:240, left: vw+550},500);
		});
	...
	$('#balloons_flying').click(function(){
		...
		$('#b1,#b3,#b5,#b7,#b9,#b20').addClass('balloons-rotate-behaviour-one');
		$('#b2,#b4,#b6,#b8,#b10,#b30').addClass('balloons-rotate-behaviour-two');
